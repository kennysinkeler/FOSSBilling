    ...
    public function handle()
    {
        ...
        $this->askStep(
            ...
            function () {
                ...
                $permission = Permission::firstOrCreate(['guard_name' => 'admin','name' => 'view admin']);
                $adminRole->givePermissionTo($permission);
                $permission = Permission::firstOrCreate(['guard_name' => 'admin','name' => 'edit settings']);
                $adminRole->givePermissionTo($permission);
                $permission = Permission::firstOrCreate(['guard_name' => 'admin','name' => 'view products']);
                $adminRole->givePermissionTo($permission);
                $staff = Role::firstOrCreate(['guard_name' => 'admin','name' => 'staff']);
